<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="https://miro.medium.com/max/113/1*YlMNRnTInfTY6RLM3lzNPg.png" height="50%" alt="VirusZzHkP" class="img-circle profile-img">
                                <h6 class="title">Hrisikesh Pal</h6>
                                <small class="info">Web Developer || Cybersecurity Student</small>
                            </div>
                            <!-- /.user-info -->
